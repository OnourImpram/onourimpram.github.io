...
export class PinterestPreview extends Component<{pin:string},{open:boolean}>{
 ...
 return <><p className="v7-pin-disclosure">Yüklemeyi seçerseniz Pinterest’e bağlanılır. IP ve tarayıcı bilgileri aktarılabilir, dış servis çerez kullanabilir. Bu bir Elif uygulama fotoğrafı değildir.</p><button className="pin-preview-button" onClick={()=>this.setState({open:true})}><Icon name="plus" size={17}/>Pinterest görselini yükle</button>
