# Elif Tasarım V10 çalışma sınırları
...
Tek etkin build `npm run build` ile `tools/build-v10.cjs` üzerinden üretilir. Eski yayın HTML'ine kod ekleme. `dist` test edilmeden yayınlama. Three.js yerel vendored modüllerini ve lisansını koru.
...
Önizleme noindex kalır. Konsept geometriyi onaylanmış üretim ölçüsü veya motor güvenliği gibi tanıtma. Kitaplık ve aksesuarları masa fiyatına otomatik dahil etme. Yeni lokasyon, müşteri, yorum, garanti ve fiyat uydurma.
